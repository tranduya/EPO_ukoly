            ...
            <body>
                <div class="content">
                    ...
                    <nav>Menu:
                        ...
                        <a href="index.php?page=uprava">Správa osobních údajů</a> |
                        <a href="index.php?page=management">Správa uživatelů</a> |
                        <a href="index.php?page=info">O nás</a> |
                        <a href="index.php?page=notes">Moje poznámky</a>
                    </nav>
                    <div>
        <?php
    }
